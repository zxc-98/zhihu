...
public class SearchService {
    ...
    public static final String solr_server_url = "http://localhost:8983/solr/zxcPro";


    //1 创建一个solrServer对象
    private static final SolrServer solrServer = new HttpSolrServer(solr_server_url);
    //private static final HttpSolrClient solrServer = new HttpSolrClient.Builder(solr_server_url).build();
    ...
    //在新增问题时候随便加入solr索引库  AddQuestionHandler 在异步事件中进行处理
    ...
    /*public static void main(String[] args) {
        ...
        List<Question> questionList = search.searchQuestion("北京", 0, 10, "<em>", "</em>");
